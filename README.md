...
User Manager est une mini application fullstack permettant de gérer des utilisateurs simplement et efficacement. Elle combine un frontend Angular moderne avec Tailwind CSS pour le design, et un backend Express léger fonctionnant entièrement en mémoire (sans base de données).
